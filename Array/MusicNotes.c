...
In Exercise 40 we have discussed frequencies of tones, for instance, for the synthesis of notes in
music. Modify tone2FrequencyHz() such that the function internally uses an array of frequencies
in Hertz for the tones A0 to G0.
 *******************************************************************************************************/
